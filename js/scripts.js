...
function nuevoEquipo() {
  ...
  let mote = document.getElementById("mote-equipo").value;
...
<div class="modal-dialog">
  ...
  let $contenedorEquipos = document.getElementById("contenedor-equipos");
  $contenedorEquipos.innerHTML += text;
  $contenedorEquipos.innerHTML += text1;
}

function confirmarBorrado(){
  var confirmacion= confirm("¿Esta seguro de borrar el equipo?");
  if (confirmacion=true)
  {
      return borrarEquipor();
  }
  else
  {
      return false;
